...
import AverageAgentRating from "../../agent-details/cards/AverageAgentRating";
import SentimentScoreGauge from '../../agent-details/cards/SentimentScoreGauge';
import TotalNumberofCalls from '../../agent-details/cards/TotalNumberofCalls';
